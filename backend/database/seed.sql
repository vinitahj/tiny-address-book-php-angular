...
VALUES (
    ...
    (
        'Blaine Houston', 'Ifeoma', 'dyvekovi@mailinator.com', 'Quae voluptas invent', '68182', 2
    ),
    (
        'Amery Bartlett', 'Xylaff', 'lehedo@mailinator.com', 'Ex rerum proident s', '69412', 4
    ),
    (
        'Alfreda Walters', 'Norman', 'tyxatep@mailinator.com', 'Non qui delectus co', '26791', 2
    ),
    (
        'Ifeoma Richard', 'Vivian', 'xydyz@mailinator.com', 'Non id quod libero ', '98404', 3
    ),
    (
        'Hayden Hancock', 'Lois', 'robubiw@mailinator.com', 'Esse et qui sed culp', '93841', 4
    );